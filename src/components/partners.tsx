        ...
        <section className="py-12 md:py-24 bg-secondary">
            <div className="container mx-auto px-4">
                ...
                <div className="overflow-hidden" ref={emblaRef}>
                    <div className="flex">
                        {partners.concat(partners).map((partner, index) => ( // Duplicate for seamless loop
                            <div key={`${partner.id}-${index}`} className="flex-shrink-0 flex-grow-0 basis-1/3 md:basis-1/5 lg:basis-1/6 p-4">
